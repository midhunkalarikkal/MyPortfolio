...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex h-[130vh] md:h-[200vh] shrink-0 scale-[0.5] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-40"
    >
